			...
			<div class="container">
              ...
              <ul class="nav pull-left">
                        ...
                        <ul class="dropdown-menu">
                                 <li><a href="<?php echo base_url(); ?>index.php/basic"><i class="icon-star"></i> Basic</a></li>
                                   <li><a href="<?php echo base_url(); ?>index.php/basic/sparql"><i class="icon-star"></i> Sparql</a></li>
                                    <li><a href="<?php echo base_url(); ?>index.php/basic/foafinfo"><i class="icon-star"></i> Foafinfo</a></li>     
                       <li><a href="<?php echo base_url(); ?>index.php/basic/foafmaker"><i class="icon-star"></i> Foafmaker</a></li>
                        <li><a href="<?php echo base_url(); ?>index.php/basic/converter"><i class="icon-star"></i> Converter</a></li>
