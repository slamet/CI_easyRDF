  ...
  <body>
   ...
   <div class="navbar  navbar-fixed-top">
			...
			<div class="container">
              ...
              <ul class="nav pull-left">
                        ...
                        <ul class="dropdown-menu">
                                 <li><a href="<?php echo base_url(); ?>index.php/basic"><i class="icon-plus"></i> Basic</a></li>
                                   <li><a href="<?php echo base_url(); ?>index.php/basic/sparql"><i class="icon-plus"></i> Sparql</a></li>
    ...
    <div class="container">     
        <!-- FOOTER -->
        <section>
            <p class="text-center muted">&copy; Copyright 2014 - <?php echo $this->config->item('nama_instansi');?><br>Created By : <a href="http://fastwebindo.com" target="_blank">FASTWEBINDO</a><br>Page rendered in <strong>{elapsed_time}</strong> seconds</p>
        </section>
    </div> <!-- end container -->
